...
\cvaddress{Zona 18, Lomas de lavarreda, segundo callej\'on, lote 27.}%address
\cvnumberphone{+502 3556-8775}%telphone number
\cvmail{hfcarrerasoto@ieee.org / hfcarrerasoto@gmail.com}%e-mail
\cvmail{hfcarrerasoto@ieee.org / hfcarrerasoto@gmail.com}%e-mail
\cvsite{www.linkedin.com/in/h\'e ctor-fernando-carrera-soto-336668118}%personal site


\aboutme{

%Estudiante en la facultad de ingenier\'ia en la Universidad de San Carlos de Guatemala,
%en el cuarto a\~no de ingenier\'ia electr\'onica. Miembro activo de la rama estudiantil del instituto de
%%ingenieros el\'ectricos y electr\'onicos (IEEE USAC).Vicepresidente en el cap\'itulo estudiantil del instituto
%de ingenieros el\'ectricos y electr\'onicos en la sociedad de rob\'otica y automatizaci\'on, electo para presidente durante el a\~no 2021.}

Amante de la m\'usica, me encanta pintar y aprender nuevas cosas que puedan ayudarme en el futuro. Amo los animales, la naturaleza, los libros y un buen caf\'e guatemalteco, el sonido de la lluvia durante las tardes y observar las estrellas.
...
\begin{twenty}
	...
	\twentyitem
    	...
    	{Esta especializaci\'on, que consta de seis cursos cortos, para estudiantes que esperan trabajar en el campo de la rob\'otica o emprender estudios.}
...
\begin{itemize}
	...
	\item[-] \textbf{Otto Guillermo Alvarez Torres.}\\
